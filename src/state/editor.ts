...
export const initialState: EditorState = {
  ...
  furnitureAssets: [
    {
      id: "asset-starter-sofa",
      prompt: "low modular sofa blockout",
      name: "Modular Sofa",
      status: "mock",
      createdAt: Date.now(),
      primitive: "sofa",
    ...
    {
      id: "asset-starter-table",
      prompt: "round coffee table blockout",
      name: "Coffee Table",
      status: "mock",
  ...
  furnitureInstances: [
    {
      id: "inst-sofa-1",
      assetId: "asset-starter-sofa",
      name: "Modular Sofa",
      position: [-1.25, 0.34, 0.9],
      rotation: [0, 0, 0],
      scale: [1, 1, 1],
    },
    {
      id: "inst-table-1",
      assetId: "asset-starter-table",
      name: "Coffee Table",
      position: [0.75, 0.22, 0.15],
      rotation: [0, 0.35, 0],
      scale: [1, 1, 1],
    },
  ],
