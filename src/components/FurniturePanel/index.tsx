...
import { Download, Minus, Package, Plus, Sparkles } from "lucide-react";
...
export function FurniturePanel({ open, assets, onGenerate, onClose }: FurniturePanelProps) {
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: 2, flexShrink: 0 }}>
          <PanelIconBtn label="Export" icon={<Download size={11} strokeWidth={1.5} />} />
